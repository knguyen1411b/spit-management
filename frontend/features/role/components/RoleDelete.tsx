...
export default function RoleDelete({ id, code }: { id: number; code: string }) {
  ...
  return (
    <Fragment>
      ...
      <Modal
        ...
        title={
          <Typography>
            <Title level={3}>Xoá chức vụ</Title>
          </Typography>
        }
        width={500}
        centered
      ...
      >
        <div className="space-y-4 text-sm text-gray-700">
          <p className="dark:text-white">Bạn có chắc chắn muốn xóa chức vụ?</p>
